        ...
        <div class="row flex-grow g-0 w-100">
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-4">
              ...
              <h4 class="mb-1 fw-semibold" style="color: #1e1e2f;">Definir nova senha</h4>
              <p class="text-secondary mb-4" style="font-size: 0.95rem;">Crie uma senha segura para acessar sua conta.</p>

              <form class="pt-2">
                <div class="form-group">
                  <label for="codigo" class="text-muted">Codigo recebido</label>
                  <div class="input-group">
                    <span class="input-group-text bg-white border-end-0">
                      <i class="ti-key text-primary" style="font-size: 1.1rem;"></i>
                    </span>
                    <input type="text" class="form-control border-start-0 ps-0" id="codigo" placeholder="Ex: 4F9D2A" style="background: white;">
                  </div>
                </div>
                <div class="form-group">
                  <label for="nova-senha" class="text-muted">Nova senha</label>
                  <div class="input-group">
                    <span class="input-group-text bg-white border-end-0">
                      <i class="ti-lock text-primary" style="font-size: 1.1rem;"></i>
                    </span>
                    <input type="password" class="form-control border-start-0 ps-0" id="nova-senha" placeholder="Crie uma senha" style="background: white;">
                  </div>
                </div>
                <div class="form-group">
                  <label for="confirmar-nova-senha" class="text-muted">Confirmar nova senha</label>
                  <div class="input-group">
                    <span class="input-group-text bg-white border-end-0">
                      <i class="ti-lock text-primary" style="font-size: 1.1rem;"></i>
                    </span>
                    <input type="password" class="form-control border-start-0 ps-0" id="confirmar-nova-senha" placeholder="Repita a senha" style="background: white;">
                  </div>
                </div>

                <button class="btn btn-primary w-100 mb-4 py-2" type="button">ATUALIZAR SENHA</button>

                <div class="text-center">
                  <span class="text-muted" style="font-size: 0.95rem;">Voltar para o</span>
                  <a href="login.php" class="text-primary ms-1 fw-semibold">login</a>
                </div>
              </form>
            </div>
          </div>
