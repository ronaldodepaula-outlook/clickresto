                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row icons-list">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <i class="mdi mdi-format-float-start"></i> mdi mdi-format-float-start
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <i class="mdi mdi-format-float-none"></i> mdi mdi-format-float-none
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <i class="mdi mdi-format-float-end"></i> mdi mdi-format-float-end
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <i class="mdi mdi-lock-outline-box"></i> mdi mdi-lock-outline-box
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-3">
